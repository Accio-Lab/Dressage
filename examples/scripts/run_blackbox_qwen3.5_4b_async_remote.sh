...
dressage_apply_common_defaults "qwen3.5-4B-async-remote" "blackbox" "e2b"
...
EVAL_ARGS=(
   # Fully async blackbox rollout does not support evaluation yet.
   # --eval-interval 20
)
...
SGLANG_ARGS=(
  ...
  #  --sglang-log-requests-target /root/log/sglang/requests/
